...
use Khazhinov\LaravelLighty\OpenApi\Complexes\StoreAction\StoreActionArgumentsDTO;
use ReflectionException;
use Spatie\DataTransferObject\Exceptions\UnknownProperties;

class StoreActionComplex extends ComplexFactory
{
    /**
    ...
    {
        $arguments = new StoreActionArgumentsDTO($arguments);
